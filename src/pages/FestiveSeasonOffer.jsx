...
export default function FestiveSeasonOffer() {
  ...
  const loadData = async () => {
    ...
    try {
      const publishedCourses = await base44.entities.Course.filter({ status: 'published' }, '-created_date');
