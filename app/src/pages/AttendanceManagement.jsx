...
export default function AttendanceManagement() {
  ...
  const loadData = async () => {
    ...
    try {
      ...
      const allAttendance = await apiClient.entities.Attendance.list("-class_date");
    ...
    try {
      ...
      const attendancePromises = courseEnrollments.map(async (enrollment) => {
        ...
        if (enrollment.student_id) {
          try {
            const studentData = await apiClient.entities.User.get(enrollment.student_id);
        ...
        return apiClient.entities.Attendance.create({
