...
export default function AdminEventManagement() {
  ...
  const loadEvents = async () => {
    ...
    try {
      const allEvents =
        await apiClient.entities.Event.list("-created_date");
  ...
  const handleSaveEvent = async () => {
    ...
    try {
      ...
      if (editingEvent) {
        await apiClient.entities.Event.update(
          editingEvent.id,
          eventData
        );
      } else {
        await apiClient.entities.Event.create(eventData);
      }
  ...
  const handleEditEvent = (event) => {
    ...
    setFormData({
      ...
      event_date: event.event_date
        ...
        : "",
      category: event.category || "achievement",
  ...
  const handleDeleteEvent = async (eventId) => {
    ...
    try {
      await apiClient.entities.Event.delete(eventId);
      await loadEvents();
    } catch (error) {
            ...
            <div className="grid md:grid-cols-2 gap-4">
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  placeholder="e.g., Hindi Prachar Sabha Exam Results"
                />
              </div>
            ...
            <div className="space-y-2">
              ...
              >
                ...
                <SelectContent>
                  ...
                  <SelectItem value="cultural_event">
                    Cultural Event
                  </SelectItem>
