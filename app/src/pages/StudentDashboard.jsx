...
export default function StudentDashboard() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* QUICK ACCESS -- shared component, also used identically on the
          Admin and Tutor dashboards, so a future feature only needs to be
          added in QuickAccessRow once to show up everywhere. getFeatureAccess()
          resolves an admin-set StudentFeatureAccess row if one exists,
          falling back to hasConfirmedEnrollment otherwise. */}
      <QuickAccessRow
